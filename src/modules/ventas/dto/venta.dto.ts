...
export const ActualizarVentaSchema =
    z.object({
...
export const ConsultarVentasSchema =
    z.object({
...
export type VentaDetalleDto =
    z.infer<
        typeof VentaDetalleSchema
    >;

export type CrearVentaDto =
    z.infer<
        typeof CrearVentaSchema
    >;

export type ActualizarVentaDto =
    z.infer<
        typeof ActualizarVentaSchema
    >;

export type ConsultarVentasDto =
    z.infer<
        typeof ConsultarVentasSchema
    >;