...
router.get(
    '/',
    authorize('Gastos', 'Ver'),
    gastoController.obtenerTodos
);
...
router.patch(
    '/:id/anular',
    authorize('Gastos', 'Anular'),
    gastoController.anular
);
