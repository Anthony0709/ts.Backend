...
import { CrearConfiguracionDto, ActualizarConfiguracionDto } from '../dto/configuracion.dto';
...
export class ConfiguracionService {
    ...
    async crear(empresaId: string, data: CrearConfiguracionDto) {
        ...
        if (existente) {
            throw new AppError('La configuración de la empresa ya existe.', 400);
        }
        return prisma.configuracion.create({
            data: {
                ...
                porcentajeMaxDescuento: new Prisma.Decimal(data.porcentajeMaxDescuento),
    ...
    async actualizar(empresaId: string, data: ActualizarConfiguracionDto) {
        ...
        if (!configuracion) {
            throw new AppError('La configuración de la empresa no existe.', 404);
        }
        return prisma.configuracion.update({
            ...
            data: {
                ...
                ...(data.iva !== undefined && { iva: new Prisma.Decimal(data.iva) }),
                ...
                ...(data.porcentajeMaxDescuento !== undefined && { porcentajeMaxDescuento: new Prisma.Decimal(data.porcentajeMaxDescuento) }),
    ...
    async restaurar(empresaId: string) {
        const configuracion = await prisma.configuracion.findUnique({
            where: {
                empresaId
            }
        ...
        return prisma.configuracion.update({
            ...
            data: {
                ...
                porcentajeMaxDescuento: new Prisma.Decimal(20),
                dobleFactor: false,
