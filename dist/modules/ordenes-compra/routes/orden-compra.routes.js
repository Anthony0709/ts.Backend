...
const orden_compra_controller_1 = require("../controllers/orden-compra.controller");
 ...
 */
router.get('/', (0, authorize_middleware_1.authorize)('OrdenesCompra', 'Ver'), orden_compra_controller_1.ordenCompraController.obtenerTodos);
/*=====================================================
====================== OBTENER ========================
=====================================================*/
/**
 ...
 *         description: Error interno del servidor.
 */
router.get('/:id', (0, authorize_middleware_1.authorize)('OrdenesCompra', 'Ver'), orden_compra_controller_1.ordenCompraController.obtenerPorId);
/*=====================================================
======================= CREAR =========================
=====================================================*/
/**
 ...
 *         description: Error interno del servidor.
 */
router.post('/', (0, authorize_middleware_1.authorize)('OrdenesCompra', 'Crear'), orden_compra_controller_1.ordenCompraController.crear);
/*=====================================================
===================== ACTUALIZAR ======================
=====================================================*/
/**
 ...
 */
router.put('/:id', (0, authorize_middleware_1.authorize)('OrdenesCompra', 'Editar'), orden_compra_controller_1.ordenCompraController.actualizar);
/*=====================================================
======================= APROBAR =======================
=====================================================*/
/**
 ...
 *         description: Error interno.
 */
router.patch('/:id/aprobar', (0, authorize_middleware_1.authorize)('OrdenesCompra', 'Aprobar'), orden_compra_controller_1.ordenCompraController.aprobar);
/*=====================================================
====================== CANCELAR =======================
=====================================================*/
/**
 ...
 *         description: Error interno.
 */
router.patch('/:id/cancelar', (0, authorize_middleware_1.authorize)('OrdenesCompra', 'Anular'), orden_compra_controller_1.ordenCompraController.cancelar);
