 ...
 */
router.get('/', (0, authorize_middleware_1.authorize)('Cotizaciones', 'Ver'), cotizacion_controller_1.cotizacionController.obtenerTodos);
/*=====================================================
====================== OBTENER ========================
=====================================================*/
/**
 ...
 */
router.get('/:id', (0, authorize_middleware_1.authorize)('Cotizaciones', 'Ver'), cotizacion_controller_1.cotizacionController.obtenerPorId);
/*=====================================================
======================= CREAR =========================
=====================================================*/
/**
 ...
 *         description: Error interno.
 */
router.post('/', (0, authorize_middleware_1.authorize)('Cotizaciones', 'Crear'), cotizacion_controller_1.cotizacionController.crear);
/*=====================================================
===================== ACTUALIZAR ======================
=====================================================*/
/**
 ...
 *         description: Error interno.
 */
router.put('/:id', (0, authorize_middleware_1.authorize)('Cotizaciones', 'Editar'), cotizacion_controller_1.cotizacionController.actualizar);
/*=====================================================
======================= APROBAR =======================
=====================================================*/
/**
 ...
 *         description: Error interno.
 */
router.patch('/:id/aprobar', (0, authorize_middleware_1.authorize)('Cotizaciones', 'Aprobar'), cotizacion_controller_1.cotizacionController.aprobar);
/*=====================================================
====================== RECHAZAR =======================
=====================================================*/
/**
 ...
 *         description: Error interno.
 */
router.patch('/:id/rechazar', (0, authorize_middleware_1.authorize)('Cotizaciones', 'Anular'), cotizacion_controller_1.cotizacionController.rechazar);
/*=====================================================
====================== CONVERTIR ======================
=====================================================*/
/**
 ...
 *         description: Error interno.
 */
router.patch('/:id/convertir', (0, authorize_middleware_1.authorize)('Cotizaciones', 'Editar'), cotizacion_controller_1.cotizacionController.convertir);
