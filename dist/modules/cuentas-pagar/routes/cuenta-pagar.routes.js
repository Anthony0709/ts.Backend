...
const cuenta_pagar_controller_1 = require("../controllers/cuenta-pagar.controller");
 ...
 */
router.get('/', (0, authorize_middleware_1.authorize)('CuentasPagar', 'Ver'), cuenta_pagar_controller_1.cuentaPagarController.obtenerTodos);
/*=====================================================
====================== OBTENER ========================
=====================================================*/
/**
 ...
 */
router.get('/:id', (0, authorize_middleware_1.authorize)('CuentasPagar', 'Ver'), cuenta_pagar_controller_1.cuentaPagarController.obtenerPorId);
/*=====================================================
======================= CREAR =========================
=====================================================*/
/**
 ...
 *         description: Error interno.
 */
router.post('/', (0, authorize_middleware_1.authorize)('CuentasPagar', 'Crear'), cuenta_pagar_controller_1.cuentaPagarController.crear);
/*=====================================================
===================== ACTUALIZAR ======================
=====================================================*/
/**
 ...
 *         description: Error interno.
 */
router.put('/:id', (0, authorize_middleware_1.authorize)('CuentasPagar', 'Editar'), cuenta_pagar_controller_1.cuentaPagarController.actualizar);
/*=====================================================
==================== REGISTRAR PAGO ===================
=====================================================*/
/**
 ...
 *         description: Error interno.
 */
router.post('/:id/pagos', (0, authorize_middleware_1.authorize)('CuentasPagar', 'Editar'), cuenta_pagar_controller_1.cuentaPagarController.registrarPago);
/*=====================================================
==================== CONSULTAR PAGOS ==================
=====================================================*/
/**
 ...
 *         description: Error interno.
 */
router.get('/:id/pagos', (0, authorize_middleware_1.authorize)('CuentasPagar', 'Ver'), cuenta_pagar_controller_1.cuentaPagarController.obtenerPagos);
